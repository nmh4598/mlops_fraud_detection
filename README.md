...
3.  Deploy model predictor
    ...
    -   Test model predictor
        ...
        curl -X POST http://3.26.37.95:8000/phase-1/prob-1/predict -H "Content-Type: application/json" -d @data/curl/phase-1/prob-1/payload-1.json
